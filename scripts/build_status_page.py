...
AUTHOR_MAP = {
    ...
    "Beyond retirement: work-role states, economic security and healthy ageing transitions across five ageing cohorts": "Quan Wen；Mazran Ismail；Muhammad Hafeez Abdul Nasir；Yanting Wu；Esraa Sh. Abbaas（MTS author order matches LaTeX; MTS marks only QUAN WEN as Corr, while LaTeX marks Quan Wen and Dr. Mazran Ismail as corresponding authors）",
    "Multidomain ageing-burden trajectories define healthy-ageing transitions across harmonized cohorts": "Quan Wen；Mazran Ismail；Muhammad Hafeez Abdul Nasir；Yanting Wu（portal only marked Quan Wen as Corr; LaTeX uses Dr. prefixes and marks Dr. Mazran Ismail as co-corresponding）",
...
CORRESPONDING_AUTHOR_MAP = {
    ...
    "Beyond retirement: work-role states, economic security and healthy ageing transitions across five ageing cohorts": ["Quan Wen"],
    "Multidomain ageing-burden trajectories define healthy-ageing transitions across harmonized cohorts": ["Quan Wen"],
