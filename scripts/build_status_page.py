...
AUTHOR_MAP = {
    ...
    "基于多模态特征学习的依赖感知三维场景图生成：用于自动化居家适老环境评估": "Quan Wen；Mazran Ismail；Muhammad Hafeez Abdul Nasir；Yanting Wu",
    "基于条件 GAN 与随机森林的多源数据融合社区韧性评估：来自中国河南的证据": "Quan Wen；Mazran Ismail；Muhammad Hafeez Abdul Nasir；Yanting Wu",
    "老年游客对遗产建筑增强现实解说的接受度：扩展技术接受模型": "Quan Wen",
    "历史社区智慧适老化改造策略的居民支持：整合地方依恋与技术接受": "Quan Wen",
    ...
    "基于注意力机制与跨模态特征融合的痴呆早期检测多模态情绪分析": "Quan Wen；Yanting Wu；Mazran Ismail；Muhammad Hafeez Abdul Nasir",
    ...
    "cGAN 辅助的适老住宅改造多目标优化": "Quan Wen",
    "元学习增强的少样本居家安全等级分类框架": "Quan Wen",
    "适老住宅缺陷评估中的视觉语言模型综述": "Quan Wen",
    ...
    "从空间符号到社会实践：适老文化主题建筑空间意义建构的动态框架": "Quan Wen",
    "遗产街区中老年人的意义建构与地方依恋：结构方程模型框架": "Quan Wen",
    "面向文化主题公共建筑老年用户的空间意义感知量表开发：因子分析研究设计": "Quan Wen",
    ...
    "AFLE-HIV：中国老年 HIV 感染者适老居住环境评估框架构建": "Quan Wen",
...
CORRESPONDING_AUTHOR_MAP = {
    ...
    "基于条件 GAN 与随机森林的多源数据融合社区韧性评估：来自中国河南的证据": ["Quan Wen"],
    "老年游客对遗产建筑增强现实解说的接受度：扩展技术接受模型": ["Quan Wen"],
    "历史社区智慧适老化改造策略的居民支持：整合地方依恋与技术接受": ["Quan Wen"],
    ...
    "基于注意力机制与跨模态特征融合的痴呆早期检测多模态情绪分析": ["Quan Wen"],
