...
| 32 | 面向多层粮仓全年能源优化的双模式辐射制冷与太阳能供热 | Energy and Buildings（已拒稿） → Energy（待人工声明/Build PDF/最终提交） | 🟠 投稿准备中 | kingtou 已推进至 Editorial Manager 不完全投稿 EGY-S-26-13470 / docID 227389；已上传 manuscript/cover letter/declaration/highlights，已填写 Article type、Section、Classifications、标题、摘要、关键词、作者、通讯作者 ORCID、CRediT、基金和个人邮箱说明；当前停在 Additional Information 问卷页，含资助确认、唯一投稿、数据可用性、SSRN 等需作者本人确认的声明，待人工确认后再 Build PDF for Approval 并最终审批/提交；邮箱仅找到 Elsevier 转投拒稿通知：稿号 ENB-D-26-01660，未找到正式 decision 邮件正文，待确认是否与 #19 为同一稿件 |
