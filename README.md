...
<td bgcolor="#f2f2f2" style="background-color:#f2f2f2; vertical-align: top;">Multimedia Tools and Applications</td>
<!-- 后台情况说明：Submission started (not yet completed). 2026-05-07 已按 Springer/Editorial Manager / Multimedia Tools and Applications 准备、编译、提交并推送 LaTeX 源文件包至论文仓库 fdc9db3ba68a86b9fb58059a86f604e8f1484523；EM 草稿 MTAP-S-26-02910 已建立并上传 manuscript.tex、references.bib、manuscript.bbl、sn-jnl.cls、sn-mathphys-num.bst 和 9 个 figure PDF；当前停在 Additional Information 页，因系统提示 “This page is being accessed by another user. Some actions are not available.” 未继续保存元数据，最终提交尚未完成。 -->
</tr>
