...
table.paper-status-table th:nth-child(3), table.paper-status-table td:nth-child(3) { min-width: 520px; width: 42%; }

table.paper-status-table th:nth-child(4), table.paper-status-table td:nth-child(4) { min-width: 520px; width: 42%; }
...
<table class="paper-status-table" width="100%" style="width:100%; min-width:1220px;">
...
<tr><th>#</th><th>状态</th><th>论文标题</th><th>投稿轨迹</th></tr>
