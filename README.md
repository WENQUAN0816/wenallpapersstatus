...
| 32 | 面向多层粮仓全年能源优化的双模式辐射制冷与太阳能供热 | Energy and Buildings（已拒稿） → Energy（等待作者审批/最终提交） | 🟠 投稿准备中 | kingtou 已推进至 Editorial Manager 作者审批队列 EGY-S-26-13470 / docID 227389；已上传 manuscript/cover letter/declaration/highlights，已填写 Article type、Section、Classifications、问卷、标题、摘要、关键词、作者、通讯作者 ORCID、CRediT、基金和个人邮箱说明；Publishing Options 外部页报错后已按系统提示 Continue with submission，当前在 Submissions Waiting for Author's Approval，状态为 Building PDF；需 PDF 生成完成后人工 View Submission、确认 Publishing Ethics/Copyright，并最终批准提交；邮箱仅找到 Elsevier 转投拒稿通知：稿号 ENB-D-26-01660，未找到正式 decision 邮件正文，待确认是否与 #19 为同一稿件 |
