...
| 32 | 面向多层粮仓全年能源优化的双模式辐射制冷与太阳能供热 | Energy and Buildings（已拒稿） → Energy（待人工 Build PDF/最终提交） | 🟠 投稿准备中 | kingtou 已推进至 Editorial Manager 不完全投稿 EGY-S-26-13470 / docID 227389；已上传 manuscript/cover letter/declaration/highlights，已填写 Article type、Section、Classifications、问卷、标题、摘要、关键词、作者、通讯作者 ORCID、CRediT、基金和个人邮箱说明；当前仍在 Incomplete Submissions，需人工点击 Build PDF for Approval 并完成最终审批/提交；邮箱仅找到 Elsevier 转投拒稿通知：稿号 ENB-D-26-01660，未找到正式 decision 邮件正文，待确认是否与 #19 为同一稿件 |
| 33 | 相变材料赋能的多层粮仓自适应多温区控制：实验与数值结合研究 | Applied Energy（已拒稿） → Applied Thermal Engineering（已拒稿） → Physics of Fluids（待作者协议/最终提交） | 🟠 投稿准备中 | kingtou 已推进 PeerX 稿件 POF26-AR-07216；已上传 manuscript.pdf，填写标题、摘要、作者排序、通讯作者、CRediT、分类、关键词、Publishing Permissions、常规出版、基金、数据可用性，并批准转换后的 manuscript.pdf；当前唯一阻塞为 Contributing Author Agreement response is required，需作者手动处理协议后再进入最终 Submit Manuscript；Applied Energy：不适合期刊读者群；Applied Thermal Engineering：初筛认为影响力、新颖性和整体质量未达门槛，编辑备注“论文内容不足以在该刊发表” |
| 34 | 面向多层粮仓围护结构的梯度纳米结构气凝胶复合保温材料 | Construction and Building Materials（已拒稿） → Journal of Materials Research and Technology-JMR&T（待 OA 条款/最终提交） | 🟠 投稿准备中 | kingtou 已推进 Elsevier 新投稿服务至 review 页 7/8；已上传 cover_letter.pdf、declarationStatement.docx、manuscript.pdf，填写 article type、元数据、摘要、关键词、3 位作者、通讯作者、分类、反对审稿人和 SSRN 选项；当前剩余 Decide if you want to publish open access，OA 选项显示 APC 1,760.00 EUR 且保存绑定 Elsevier 开放获取购买条款/费用责任，需人工决定并保存后再处理最终 review 勾选和 Complete your submission；稿号 CONBUILDMAT-D-26-04279；2026-03-30 外审后拒稿 |
...
| 9 | 中国 HIV 老年人适老居住环境因素因果模型：文本挖掘、模糊 DEMATEL 与区域比较 | Journal of Urban Health（已拒稿） → Frontiers in Public Health（投稿准备中） | 🟠 投稿准备中 | kingtou 已开始投稿（尚未最终提交）；Frontiers in Public Health 上传包提交 a5f84c0，Frontiers 草稿 10081331 已选择 Public Health - Aging and Public Health、Original Research，并上传 manuscript.tex、references.bib、manuscript.pdf，Submission details 与 Manuscript information 已完成；当前停在 Authors/Statements/Payment，需作者补第一作者电话、第二作者邮箱、机构/贡献确认及伦理/数据/COI/APC 声明；页面还出现 manuscript already under consideration/最终 Submit 确认相关提示，需作者确认是否继续，最终 Submit 未点击 |
...
| 49 | 对比学习增强的 RGB-D 居家安全区域分割知识蒸馏 | Sensors | 🟡 已投稿 | 已投稿 |
| 5 | 智慧养老系统中智能情绪监测与干预的双通道注意力机制 | Biomedical Signal Processing and Control | 🟡 已投稿 | 已投稿 |
| 50 | 灵活半监督元学习少样本居家安全评估网络 | Sensors | 🟡 已投稿 | 已投稿 |
| 53 | VLM 驱动的适老住宅缺陷自动评估与报告生成 | Sensors | 🟡 已投稿 | 已投稿 |
| 55 | 住宅环境设计特征对老年人生理心理福祉影响的 VR 实验 | PLOS ONE | 🟡 已投稿 | 已投稿 |
| HAN-EI-1 | LLM 生成测试用例优化：AI 辅助软件测试中的质量缺陷表征与缓解 | Software Testing, Verification and Reliability | 🟡 已投稿 | 已投稿 |
| HAN-EI-2 | 用于自动代码审查评论生成的上下文与结构特征融合混合 Transformer-MLP 模型 | Software: Practice and Experience | 🟡 已投稿 | 已投稿 |
| HAN-EI-3 | 基于大语言模型苏格拉底式推理的可解释自动代码审查 | Software: Practice and Experience | 🟡 已投稿 | 已投稿 |
| HAN-EI-4 | DHA-BiGRU：用于自动代码审查评论分类的双注意力层次门控 BiGRU | Software Testing, Verification and Reliability | 🟡 已投稿 | 已投稿 |
